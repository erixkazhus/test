               ...
               <div className='relative max-w-7xl mx-auto'>
                <div className='flex h-[650px] justify-center items-center lg:pt-0 pt-20'>
                    <div className='flex flex-col space-y-8 justify-center items-center text-center px-5 md:px-0'>
                        ...
                        <p className='text-white lg:text-lg lg:w-[700px]'>Discover the myths that are hidden behind the history of every Greek island, by having your holidays in Greece combined with our breathtaking Corfu all-gay cruise</p>
        ...
        <div className='flex gap-3 items-center'>
            <div className='grid gap-5 grid-cols-4 flex-grow'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <input id="check-in" type="date" className='border p-1 border-gray-300 rounded-sm'/>
                </div>
                <div className='flex flex-col gap-2'>
                    <label htmlFor="check-out" className='font-semibold'>Check Out</label>
                    <input id="check-out" type="date" className='border p-1 border-gray-300 rounded-sm'/>
                </div>
                <div className='flex flex-col gap-2'>
            ...
            <div className='flex flex-col'>
                ...
                <input
                  ...
                  id="transmission"
                  name="transmission"
                  className="border p-1 border-gray-300 rounded-sm mb-2"
